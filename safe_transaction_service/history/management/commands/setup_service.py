...
#         ('0x6851D6fDFAfD08c0295C392436245E5bc78B0185', 6723632, '1.2.0'),
        ('0x5965d31dfde06ec83108cc44c0bc37ad95bd8644', 8700000, '1.1.1'),
#         ('0x34CfAC646f301356fAa8B21e94227e3583Fe3F5F', 8555555, '1.1.1'),
...
#         ('0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2', 8493997),  # v1.3.0
 #       ('0x76E2cFc1F5Fa8F6a5b3fC4c8F4788F0116861F9B', 8555555),  # v1.1.1
  ('0xb99d8d03aedeb48acc2ff2fdda613695ade48ad0', 8700000),  # v1.1.1
    ...
    def _setup_safe_master_copies(self, safe_master_copies: Sequence[Tuple[str, int, str]]):
        ...
        for address, initial_block_number, version in safe_master_copies:
            ...
            for ModelToInsert in ModelsToInsert:
                print(address, initial_block_number, version, )
                #
                # todo x: save db
                #
